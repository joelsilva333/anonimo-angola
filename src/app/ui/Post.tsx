...
export default function Post({
  ...
  const onSubmit: SubmitHandler<CommentInput> = async (data) => {
    try {
      ...
      toast.error(
        error?.response?.data?.error || "Erro ao comentar. Tente novamente.",
      );
    } finally {
      setLoading(false);
    }
    ...
    try {
      ...
      toast.error(
        error?.response?.data?.message ||
          "Erro ao gerar links. Tente novamente.",
      );
    }
  };
            ...
            <motion.div
              ...
              <div className="flex flex-col gap-3 w-full">
                ...
                <button
                  ...
                  className="text-sm text-gray-400 hover:text-gray-600 font-medium transition-colors duration-200 cursor-pointer mt-1">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-md p-4">
            <motion.div
              ...
              <p className="text-sm text-gray-500 mb-5">
                Ajuda a espalhar a palavra de forma anónima.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 w-full">
                {[
                  ...
                  },
                  {
                    ...
                    label: "LinkedIn",
                    color:
                      "bg-sky-50 text-sky-700 hover:bg-sky-700 hover:text-white",
                  },
                ].map((item) => (
                  <Link
                    key={item.label}
